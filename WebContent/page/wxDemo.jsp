<%@page import="com.qq.weixin.mp.aes.Sign"%>
...
<script src="weui/jscode/jweixin-1.1.0.js"></script>

<script type="text/javascript">
function dopost(str){
	var url="../servlet/dopostIntf";
	$.getJSON(url,{action:str}, function(data) {
		$('#dialogtitle').text(data.dialogtitle);
  	 	$('#dialogbd').text(data.dialogbd); 
  	 	$('#dialog2').show();
    });
}
</script>
...
<div class="container" id="container">
	<div class="dialog">
		<div class="hd">
			<h1 class="page_title">微信的各个功能调用Demo</h1>
		</div>
		<div class="bd spacing">
			<a href="javascript:dopost('getaccess');" class="weui_btn weui_btn_primary" id="showDialog2">access_token保存和获取</a>
		    <a href="javascript:dopost('ip');" class="weui_btn weui_btn_primary" id="showDialog2">IP地址获取</a>
		    <a href="javascript:dopost('setmenu');" class="weui_btn weui_btn_primary" id="showDialog2">自定义菜单创建</a>
		    <a href="javascript:dopost('getmenu');" class="weui_btn weui_btn_primary" id="showDialog2">自定义菜单查询</a>
		    <a href="javascript:dopost('delmenu');" class="weui_btn weui_btn_primary" id="showDialog2">自定义菜单删除</a>
		    <a href="javascript:dopost('kfaccount_add');" class="weui_btn weui_btn_primary" id="showDialog2">添加客服帐号</a>
		    <a href="javascript:dopost('kfaccount_send');" class="weui_btn weui_btn_primary" id="showDialog2">客服帐号发送信息</a>
		    <a href="javascript:dopost('upload');" class="weui_btn weui_btn_primary" id="showDialog2">上传图文永久素材</a>
		    <a href="javascript:dopost('get_material');" class="weui_btn weui_btn_primary" id="showDialog2">获取永久素材</a>
		</div>
		<!--BEGIN dialog2-->
		<div class="weui_dialog_alert" id="dialog2" style="display: none;">
		   <div class="weui_mask"></div>
		   <div class="weui_dialog">
		       <div class="weui_dialog_hd" id="dialogtitle"><strong class="weui_dialog_title"></strong></div>
		       <div class="weui_dialog_bd" id="dialogbd"></div>
...
<%
	...
	Map<String, String> pageSign = Sign.sign(jsapi_ticket, url);
%>
</body>
<script>
  /*
  ...
  wx.config({
      debug: true,
      appId: 'wx59b7808564d41566',
      timestamp: <%=pageSign.get("timestamp")%>,
      nonceStr: '<%=pageSign.get("nonceStr")%>',
      signature: '<%=pageSign.get("signature")%>',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
...
<script src="weui/router.min.js"></script>
<script src="weui/jdkapi.js"></script>
</html>